...
def get_functionality():
    ...
    prompt="""
       Extract the functionalities from the provided [context]. If there is a requirement list within the context, identify the main product [main product] and list its functionalities accordingly. 
        Add the Discription for each functionlity if they are in [context] or write by yourself.
        Note: The terminology used for functionalities may vary in different business documents.Gather the functionality details accordingly.
        Give the output in exact JSON format as like sample output. Remove the word json from the output.
        ...
        ""description":"This is a registration function"
        }
        ]
        Helpful Answer:
    """
    ...
    functionality=[data]
    # Extract and print functionalities
    for key, value in data.items():
        functionalities.append(value["functionality"])
    # temp=""
    ...
    # discription_prompt="""Write Discription for each functionality in the functionality list {functionality}
    # Return the result in JSON format.
    # """

    # print(temp)
    # discription_chain=({"functionality": temp} 
    #       |discription_prompt | model |StrOutputParser()
    #       )
    
    # response=discription_chain.invoke()
